...
export default function FormProduct({ setOpen, product }) {
  ...
  const onSubmit = async (data) => {
    const fileNames = Array.from(data.images).map((file) => file.name);

    // Utilizar fileNames en lugar de data.images en tu lógica de envío
    ...
    if (product) {
      try {
        ...
        toast.error('Error adding product. Please try again.', error.message);
      }
    } else {
      try {
                  ...
                  <div className="space-y-1 text-center">
                    ...
                    <div className="flex text-sm text-gray-600">
                      ...
                      >
                        ...
                        <input id="images" name="images" type="file" className="sr-only" {...register('images')} multiple />
                      </label>
